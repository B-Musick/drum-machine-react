...
const App = () => {
    return (
        <div>
            ...
            <p id="developed-by-container">Developed By: <span id="developed-by-name">Brendan Musick</span></p>
        </div>
...
class DrumPads extends React.Component {
    ...
    handleOnClick = (e)=> {
        ...
        // Play the sound, the key is associated with a letter, and the letter is the key of the sound
        // which uses the HTML5 audio method 'play()' to play
...
const PadDetail = (props) => {
    // Receives pad object from DrumPads component
    // {key:letter,letter:audio,displayText:'string'}
    let pad = props.pad; 
